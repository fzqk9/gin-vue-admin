...
// Author [piexlmax](https://github.com/piexlmax)
func (cmsAdService *CmsAdService)GetCmsAd(id uint) (err error, obj autocode.CmsAd) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (cmsAdService *CmsAdService)GetCmsAdInfoList(info autoCodeReq.CmsAdSearch, createdAtBetween []string) (err error, list interface{}, total int64) {
	limit := info.PageSize
